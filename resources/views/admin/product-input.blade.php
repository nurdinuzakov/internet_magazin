                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user-menu">
                            <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                ...
                                <span class="d-none d-lg-inline-block">Uzakov Nurdin</span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <!-- User image -->
                                <li class="dropdown-header">
                                    ...
                                    <div class="d-inline-block">
                                        Uzakov Nurdin <small class="pt-1">nurdinuzakov@gmail.com</small>
                                    </div>
                                </li>
                            ...
                            <div class="card-body">
                                <form>
                                    <div class="form-group">
                                        <label for="validationDefaultUsername">Product name</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="validationDefaultUsername" placeholder="Product name" aria-describedby="inputGroupPrepend2"
                                                   required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="validationDefaultUsername">Supplier id</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="validationDefaultUsername" placeholder="Supplier id" aria-describedby="inputGroupPrepend2"
                                                   required>
                                        </div>
                                    </div>
